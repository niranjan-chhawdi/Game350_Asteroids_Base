...
public class Asteroid_W4_Solution : BaseWrappingObject_W4_Solution
{
   ...
   //private Vector2 activeBounds = new Vector2(12, 6); //REMOVE
    ...
    private Asteroid_W4_Solution SplitAsteroid(Asteroid_W4_Solution parentAsteroid)
    {
        ...
        Asteroid_W4_Solution splitAst = Instantiate(this, position, transform.rotation);
