...
public class Asteroid_W6_Solution : BaseWrappingObject_W6_Solution
{
   ...
   //private Vector2 activeBounds = new Vector2(12, 6); //REMOVE
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        if (collision.gameObject.CompareTag("Bullet"))
        {
            ...
            GameManager_W6_Solution.Instance.ScoreOnAsteroidDestroy();
    ...
    private Asteroid_W6_Solution SplitAsteroid(Asteroid_W6_Solution parentAsteroid)
    {
        ...
        Asteroid_W6_Solution splitAst = Instantiate(this, position, transform.rotation);
